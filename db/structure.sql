...
CREATE TRIGGER clean_branch_update_events AFTER INSERT ON public.branch_update_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_branch_update_events();
...
CREATE TRIGGER clean_executor_events AFTER INSERT ON public.executor_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_executor_events();
...
CREATE TRIGGER clean_job_state_update_events AFTER INSERT ON public.job_state_update_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_job_state_update_events();
...
CREATE TRIGGER clean_repository_events AFTER INSERT ON public.repository_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_repository_events();
...
CREATE TRIGGER clean_script_state_update_events AFTER INSERT ON public.script_state_update_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_script_state_update_events();
...
CREATE TRIGGER clean_task_state_update_events AFTER INSERT ON public.task_state_update_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_task_state_update_events();
...
CREATE TRIGGER clean_trial_state_update_events AFTER INSERT ON public.trial_state_update_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_trial_state_update_events();
...
CREATE TRIGGER clean_user_events AFTER INSERT ON public.user_events FOR EACH STATEMENT EXECUTE FUNCTION public.clean_user_events();
...
CREATE TRIGGER create_branch_update_event AFTER INSERT OR UPDATE ON public.branches FOR EACH ROW EXECUTE FUNCTION public.create_branch_update_event();
...
CREATE TRIGGER create_job_state_update_events_on_insert AFTER INSERT ON public.jobs FOR EACH ROW EXECUTE FUNCTION public.create_job_state_update_events();
...
CREATE TRIGGER create_job_state_update_events_on_update AFTER UPDATE ON public.jobs FOR EACH ROW WHEN (((old.state)::text IS DISTINCT FROM (new.state)::text)) EXECUTE FUNCTION public.create_job_state_update_events();
...
CREATE TRIGGER create_pending_create_trials_evaluations_on_tasks_insert AFTER INSERT ON public.tasks FOR EACH ROW EXECUTE FUNCTION public.create_pending_create_trials_evaluations_on_tasks_insert();
...
CREATE TRIGGER create_pending_create_trials_evaluations_on_trial_state_change AFTER INSERT ON public.trial_state_update_events FOR EACH ROW WHEN (((new.state)::text = ANY ((ARRAY['aborted'::character varying, 'defective'::character varying, 'failed'::character varying, 'passed'::character varying, 'skipped'::character varying])::text[]))) EXECUTE FUNCTION public.create_pending_create_trials_evaluations_on_trial_state_change();
...
CREATE TRIGGER create_pending_job_evaluation_on_task_state_update_event_insert AFTER INSERT ON public.task_state_update_events FOR EACH ROW EXECUTE FUNCTION public.create_pending_job_evaluation_on_task_state_update_event_insert();
...
CREATE TRIGGER create_pending_result_propagation AFTER UPDATE ON public.trials FOR EACH ROW WHEN ((old.result IS DISTINCT FROM new.result)) EXECUTE FUNCTION public.create_pending_result_propagation();
...
CREATE TRIGGER create_pending_task_evaluation_on_trial_state_update_event_inse AFTER INSERT ON public.trial_state_update_events FOR EACH ROW EXECUTE FUNCTION public.create_pending_task_evaluation_on_trial_state_update_event_inse();
...
CREATE TRIGGER create_script_state_update_events_on_insert AFTER INSERT ON public.scripts FOR EACH ROW EXECUTE FUNCTION public.create_script_state_update_events();
...
CREATE TRIGGER create_script_state_update_events_on_update AFTER UPDATE ON public.scripts FOR EACH ROW WHEN (((old.state)::text IS DISTINCT FROM (new.state)::text)) EXECUTE FUNCTION public.create_script_state_update_events();
...
CREATE TRIGGER create_task_state_update_events_on_insert AFTER INSERT ON public.tasks FOR EACH ROW EXECUTE FUNCTION public.create_task_state_update_events();
...
CREATE TRIGGER create_task_state_update_events_on_update AFTER UPDATE ON public.tasks FOR EACH ROW WHEN (((old.state)::text IS DISTINCT FROM (new.state)::text)) EXECUTE FUNCTION public.create_task_state_update_events();
...
CREATE TRIGGER create_tree_id_notification_on_branch_change AFTER INSERT OR UPDATE ON public.branches FOR EACH ROW EXECUTE FUNCTION public.create_tree_id_notification_on_branch_change();
...
CREATE TRIGGER create_tree_id_notification_on_job_state_change AFTER UPDATE ON public.jobs FOR EACH ROW WHEN (((old.state)::text IS DISTINCT FROM (new.state)::text)) EXECUTE FUNCTION public.create_tree_id_notification_on_job_state_change();
...
CREATE TRIGGER create_trial_state_update_events_on_insert AFTER INSERT ON public.trials FOR EACH ROW EXECUTE FUNCTION public.create_trial_state_update_events();
...
CREATE TRIGGER create_trial_state_update_events_on_update AFTER UPDATE ON public.trials FOR EACH ROW WHEN (((old.state)::text IS DISTINCT FROM (new.state)::text)) EXECUTE FUNCTION public.create_trial_state_update_events();
...
CREATE TRIGGER executor_event AFTER INSERT OR DELETE OR UPDATE ON public.executors FOR EACH ROW EXECUTE FUNCTION public.executor_event();
...
CREATE TRIGGER executor_event_truncate AFTER TRUNCATE ON public.executors FOR EACH STATEMENT EXECUTE FUNCTION public.executor_event();
...
CREATE TRIGGER repository_event AFTER INSERT OR DELETE OR UPDATE ON public.repositories FOR EACH ROW EXECUTE FUNCTION public.repository_event();
...
CREATE TRIGGER repository_event_truncate AFTER TRUNCATE ON public.repositories FOR EACH STATEMENT EXECUTE FUNCTION public.repository_event();
...
CREATE TRIGGER update_updated_at_column_of_branches BEFORE UPDATE ON public.branches FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_commits BEFORE UPDATE ON public.commits FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_executor_issues BEFORE UPDATE ON public.executor_issues FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_executors BEFORE UPDATE ON public.executors FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_job_issues BEFORE UPDATE ON public.job_issues FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_jobs BEFORE UPDATE ON public.jobs FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_repositories BEFORE UPDATE ON public.repositories FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_scripts BEFORE UPDATE ON public.scripts FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_tasks BEFORE UPDATE ON public.tasks FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_tree_attachments BEFORE UPDATE ON public.tree_attachments FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_tree_id_notifications BEFORE UPDATE ON public.tree_id_notifications FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_tree_issues BEFORE UPDATE ON public.tree_issues FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_trial_attachments BEFORE UPDATE ON public.trial_attachments FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_trial_issues BEFORE UPDATE ON public.trial_issues FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_trials BEFORE UPDATE ON public.trials FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER update_updated_at_column_of_welcome_page_settings BEFORE UPDATE ON public.welcome_page_settings FOR EACH ROW WHEN ((old.* IS DISTINCT FROM new.*)) EXECUTE FUNCTION public.update_updated_at_column();
...
CREATE TRIGGER user_event AFTER INSERT OR DELETE OR UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.user_event();
...
CREATE TRIGGER user_event_truncate AFTER TRUNCATE ON public.users FOR EACH STATEMENT EXECUTE FUNCTION public.user_event();
